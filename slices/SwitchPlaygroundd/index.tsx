...
export type SwitchPlaygroundProps =
  SliceComponentProps<Content.SwitchPlaygrounddSlice>;
...
type SharedCanvasProps = {
  color: Content.SwitchPlaygrounddSliceDefaultPrimarySwitchesItem["switch"];
};
...
const SharedCanvas = ({ color }: SharedCanvasProps) => {
  ...
  const { hexcolor: hexColor, name } = color.data;
